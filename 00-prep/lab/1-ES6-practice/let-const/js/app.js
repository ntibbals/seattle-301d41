...
function displayPics(){
  ...
  // This is because let is scoped as a code block and can only be reassigned within the same scope in which it is declared. makeRandom is a function declared in a previous scope.
  console.log(viewed);
